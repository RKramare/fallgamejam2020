function loadPlayer(x, y)
    ...
    player.spriteStill = player.sprite.get(1, 0)
    player.spriteRight = player.sprite.get(0, 0)
    player.spriteLeft = player.sprite.get(0, 1)

    -- Attack sprites
    player.attackSpritesRight = {
        player.sprite.get(2, 0),
        player.sprite.get(3, 0),
        player.sprite.get(4, 0),
        player.sprite.get(5, 0)
    }
    player.attackSpritesLeft = {
        player.sprite.get(2, 1),
        player.sprite.get(3, 1),
        player.sprite.get(4, 1),
        player.sprite.get(5, 1)
    }
